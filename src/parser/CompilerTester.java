...
public class CompilerTester
{
    ...
    {
        String testFile = "src/parser/parserTest8.txt";
        Scanner scanner;
        try 
        {
        ...
        String originalFileName = testFile.substring(testFile.lastIndexOf('/') + 1, testFile.lastIndexOf('.'));
        Emitter emitter = new Emitter(originalFileName + ".asm");
